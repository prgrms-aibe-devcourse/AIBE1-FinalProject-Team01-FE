                ...
                <>
                    ...
                    <div className="profile-info">
                      ...
                      <div className="profile-badge">
                        ...
                        {modalInfo.devcourseBatch && (
                            <span className="batch-info">{modalInfo.devcourseBatch}기</span>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="stats-section">
                    <div className="stat-item">
                      <span className="stat-number">{modalInfo.postCount || 0}</span>
                      <span className="stat-label">게시글</span>
                    </div>
                    <div className="stat-divider"></div>
                    <div className="stat-item">
                      <span className="stat-number">{modalInfo.follwerCount || 0}</span>
                      <span className="stat-label">팔로워</span>
                    </div>
                    <div className="stat-divider"></div>
                    <div className="stat-item">
                      <span className="stat-number">{modalInfo.followingCount || 0}</span>
                      <span className="stat-label">팔로잉</span>
                    </div>
                  </div>

                  {/* 액션 버튼 섹션 */}
                  {!isAuthorByNickname(modalInfo.nickname, currentUser.nickname) && (
                      <div className="action-section">
                        ...
                        >
                          {actioning ? (
                              <Spinner as="span" animation="border" size="sm" className="btn-spinner" />
                          ) : isFollowing ? (
                              <>
